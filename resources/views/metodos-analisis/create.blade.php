...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2>Crear Método de Análisis</h2>
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('metodos-analisis.store') }}">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('limite_deteccion_default') is-invalid @enderror" 
                                           ...
                                           value="{{ old('limite_deteccion_default') }}" step="0.000001" min="0">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('limite_cuantificacion_default') is-invalid @enderror" 
                                           ...
                                           value="{{ old('limite_cuantificacion_default') }}" step="0.000001" min="0">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('tiempo_estimado_horas') is-invalid @enderror" 
                                           ...
                                           value="{{ old('tiempo_estimado_horas') }}" min="1">
                                ...
                                <div class="mb-3">
                                    <div class="form-check mt-4">
                                        <input type="checkbox" class="form-check-input" id="requiere_calibracion" 
                                               name="requiere_calibracion" value="1" {{ old('requiere_calibracion') ? 'checked' : '' }}>

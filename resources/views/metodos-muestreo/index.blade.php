...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2>Métodos de Muestreo</h2>
        <a href="{{ route('metodos-muestreo.create') }}" class="btn btn-primary">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('metodos-muestreo.index') }}">
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-3 d-flex align-items-end">
                        ...
                        <a href="{{ route('metodos-muestreo.index') }}" class="btn btn-outline-secondary">Limpiar</a>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('metodos-muestreo.show', $metodo) }}" 
                                               class="btn btn-sm btn-outline-info" title="Ver">
                                                <x-heroicon-o-eye style="width: 16px; height: 16px;" />
                                            </a>
                                            <a href="{{ route('metodos-muestreo.edit', $metodo) }}" 
                                               class="btn btn-sm btn-outline-primary" title="Editar">
                                                <x-heroicon-o-pencil style="width: 16px; height: 16px;" />
                                            </a>
                                            <a href="{{ route('metodos-muestreo.delete', $metodo) }}" 
            ...
            @else
                <div class="text-center py-4">
                    ...
                    <p class="text-muted">No se encontraron métodos de muestreo.</p>
                    <a href="{{ route('metodos-muestreo.create') }}" class="btn btn-primary">

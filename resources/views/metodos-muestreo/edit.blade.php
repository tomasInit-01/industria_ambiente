...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2>Editar Método de Muestreo</h2>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('metodos-muestreo.update', $metodoMuestreo) }}">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('codigo') is-invalid @enderror" 
                                           id="codigo" name="codigo" value="{{ old('codigo', $metodoMuestreo->codigo) }}" required>
                                    @error('codigo')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nombre') is-invalid @enderror" 
                                           id="nombre" name="nombre" value="{{ old('nombre', $metodoMuestreo->nombre) }}" required>
                                    @error('nombre')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                                      id="descripcion" name="descripcion" rows="3">{{ old('descripcion', $metodoMuestreo->descripcion) }}</textarea>
                            @error('descripcion')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('equipo_requerido') is-invalid @enderror" 
                                           id="equipo_requerido" name="equipo_requerido" value="{{ old('equipo_requerido', $metodoMuestreo->equipo_requerido) }}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('unidad_medicion') is-invalid @enderror" 
                                           id="unidad_medicion" name="unidad_medicion" value="{{ old('unidad_medicion', $metodoMuestreo->unidad_medicion) }}" 
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('procedimiento') is-invalid @enderror" 
                                      id="procedimiento" name="procedimiento" rows="4">{{ old('procedimiento', $metodoMuestreo->procedimiento) }}</textarea>
                            @error('procedimiento')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control @error('costo_base') is-invalid @enderror" 
                                               id="costo_base" name="costo_base" value="{{ old('costo_base', $metodoMuestreo->costo_base) }}" 
                                               step="0.01" min="0">
                                        @error('costo_base')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="mb-3">
                                    <div class="form-check mt-4">
                                        <input type="checkbox" class="form-check-input" id="activo" name="activo" 
                                               value="1" {{ old('activo', $metodoMuestreo->activo) ? 'checked' : '' }}>
